...
| `weight` | Traffic weight (1-100) | No (default: 100) |
...
## Appendix: Controller Configuration (v1, Legacy)

The v1 Controller is configured via YAML:
...
See the v1 Agent configuration in `deploy/config/agent.example.yaml`.
